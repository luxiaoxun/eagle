package com.alarm.eagle.alert.siddihistrem;

import com.alarm.eagle.model.*;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.alarm.eagle.alert.source.EventJsonSource;
...
public class AppTest {
    public static void main(String[] args) throws Exception {
        ...
        for (Datasource datasource1 : task.getDatasourceList()) {
            ...
            DataStream<ObjectNode> dataStream = environment.addSource(new EventJsonSource(streamId))
