...
INSERT INTO `log_rule` (`id`, `app_id`, `version`, `type`, `script`, `state`, `update_time`) VALUES (
'1', '123', '20200101', 'log-rules', 'package logrules
...
INSERT INTO `log_rule` (`id`, `app_id`, `version`, `type`, `script`, `state`, `update_time`) VALUES (
'2', '456', '20200102', 'log-rules', 'package logrules
import com.alarm.eagle.util.DateUtil;
import com.alarm.eagle.log.LogEntry;
import org.slf4j.Logger;
import com.alarm.eagle.util.Md5Util;
